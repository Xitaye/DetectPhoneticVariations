...
def clean_silence(input_dir, output_dir):
...
def main():
    parser = argparse.ArgumentParser(description="Remove silence from all .wav files in a directory")
    parser.add_argument('--input_dir', '-i', required=True,
                        help="Root input directory containing .wav files")
    parser.add_argument('--output_dir', '-o', required=True,
                        help="Root output directory for cleaned .wav files")
    args = parser.parse_args()

    input_dir = args.input_dir
    output_dir = args.output_dir

    clean_silence(input_dir, output_dir)

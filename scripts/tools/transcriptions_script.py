...
def main():
    parser = argparse.ArgumentParser(description="Process a phonetic CSV to produce formatted .txt files under language+gender dirs.")
    parser.add_argument('--csv', '-c', required=True,
                        help="Path to the CSV file (e.g. '/path/to/Phonetic Transcription.csv').")
    parser.add_argument('--out_root', '-o', required=True,
